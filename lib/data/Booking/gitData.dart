...
class Commit {
  CommitterAuthor author;
  CommitterAuthor committer;
  String message;
  Tree tree;
  String url;
  int commentCount;
  ...
  Commit.fromJson(Map<String, dynamic> json) {
    author =
        json['author'] != null ? new CommitterAuthor.fromJson(json['author']) : null;
    committer = json['committer'] != null
        ? new CommitterAuthor.fromJson(json['committer'])
        : null;
...
class CommitterAuthor {
  String name;
  String email;
  String date;

  CommitterAuthor({this.name, this.email, this.date});

  CommitterAuthor.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    email = json['email'];
    date = json['date'];
  }
...
class Author {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['gravatarId'] = this.gravatarId;
    data['url'] = this.url;
    data['html_url'] = this.htmlUrl;
...
class Parents {
  ...
  Parents({this.sha1, this.url, this.htmlUrl});
